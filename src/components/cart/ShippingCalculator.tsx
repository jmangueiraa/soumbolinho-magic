...
export const ShippingCalculator: React.FC<ShippingCalculatorProps> = ({
  ...
  return (
    <div className={`space-y-3.5 ${isCompact ? '' : 'p-4 sm:p-5 bg-slate-50/80 rounded-2xl border border-slate-200/80'}`}>
      ...
      <form onSubmit={handleFormSubmit} className="flex gap-2">
        <div className="relative flex-1">
          <input
            ...
            className="w-full text-xs font-mono font-bold px-3.5 py-2.5 bg-white border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary transition-all text-slate-900 placeholder:text-slate-400 placeholder:font-normal"
          />
          {isLoading && (
